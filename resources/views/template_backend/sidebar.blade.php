  ...
  <nav id="sidebar">
    ...
    <div class="left-custom-menu-adp-wrap">
      <ul class="nav navbar-nav left-sidebar-menu-pro">
        ...
        <li class="nav-item">
          <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fas fa-hamburger"></i> <span class="mini-dn">Product</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
          <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
            <a href="{{ route('mobil.index') }}" class="dropdown-item">List Product</a>
            <a href="{{ route('mobil.tampil_hapus') }}" class="dropdown-item">List Product Dihapus</a>
          </div>
        </li>
        <li class="nav-item"><a href="{{ route('merek.index') }}" class="nav-link dropdown-toggle"><i class="fa big-icon fa-clipboard"></i> <span class="mini-dn">Kategori</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a></li>
