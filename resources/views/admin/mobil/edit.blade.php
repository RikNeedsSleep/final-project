    ...
    <div class="welcome-wrapper shadow-reset res-mg-t mg-b-30">
      <form action="{{ route('mobil.update', $mobil->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="{{ $mobil->type }}" name="type" placeholder="Masukkan Nama Product" autocomplete="off">
        </div>
        <div class="form-group">
          <label>Harga Product</label>
            <input type="number" class="form-control" value="{{ $mobil->price }}" name="price" placeholder="Masukkan Harga Product">
        </div>
        <div class="form-group">
